...
-- 3rd
-- create view vehicle_data as
-- select v.vin, v.Prime_ride, v.vehicle_company, v.Model_year, v.type
-- from vehicle v;

-- create role head_driver
-- grant head_driver to  (select MAX(Experience) from driver);
